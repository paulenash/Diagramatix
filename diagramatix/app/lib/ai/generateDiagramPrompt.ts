...
- SELF-RELATIONSHIP: a line that LEAVES a class and LOOPS BACK to the SAME class (a small rectangular/curved loop off one side, often with a role + multiplicity at each end) is a self-connector — set BOTH "sourceId" and "targetId" to that class's id, and set "sourceSide" = "targetSide" = the side the loop sits on ("top"/"bottom"/"left"/"right"). Keep its type (association/aggregation/composition), roles, multiplicities and constraints just like any other connection.
