...
**As at:** 2026-09-04  ·  **Document version:** 7.0  ·  **Suite:** 382 test files · 2,515 tests (all green)  ·  **Runner:** Vitest  ·  **CI:** enforced on every PR + push to `main`  ·  **Highest ref:** T3202  ·  **Plus:** a Playwright browser e2e suite — see [Layer 11](#layer-11--end-to-end-playwright-browser-tests)
