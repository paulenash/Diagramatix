...
**As at:** 2026-08-27  ·  **Document version:** 6.6  ·  **Suite:** 342 test files · 2,203 tests (all green)  ·  **Runner:** Vitest  ·  **CI:** enforced on every PR + push to `main`  ·  **Highest ref:** T2900  ·  **Plus:** a Playwright browser e2e suite — see [Layer 11](#layer-11--end-to-end-playwright-browser-tests)
