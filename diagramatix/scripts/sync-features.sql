...
-- Meeting → Diagram (Audio & Transcript)
UPDATE "Feature" SET "summary"='Turn a recorded discussion into a diagram. Record or upload a conversation, or drop in a Microsoft Teams or Zoom transcript, and Diagramatix transcribes it, tidies it into an ordered process, and feeds it straight into AI Generate.', "details"='- Three ways in — record a conversation live in the browser, upload an audio file (mp3, m4a, wav, webm…), or drop a Microsoft Teams or Zoom .vtt transcript
...
- Nothing is sent until you choose: the transcript lands in the prompt box for you to read and refine first',
  "publishedName"="name", "publishedSummary"='Turn a recorded discussion into a diagram. Record or upload a conversation, or drop in a Microsoft Teams or Zoom transcript, and Diagramatix transcribes it, tidies it into an ordered process, and feeds it straight into AI Generate.', "publishedDetails"='- Three ways in — record a conversation live in the browser, upload an audio file (mp3, m4a, wav, webm…), or drop a Microsoft Teams or Zoom .vtt transcript
- High-accuracy, speaker-separated transcription via Deepgram — each voice is labelled, so distinct speakers can become distinct roles / lanes
- Meeting transcripts are read locally — a Teams or Zoom .vtt keeps everyone''s real names and costs nothing to process
- AI tidy pass — the raw, rambling transcript is cleaned into a clear, ordered process description (filler, repetition and small talk removed) before the diagram is built, so messy meetings still produce a sensible result
- Open questions surfaced — if the discussion left something ambiguous or unfinished, the AI flags it for you to resolve rather than guessing
...
- Nothing is sent until you choose: the transcript lands in the prompt box for you to read and refine first',
  "publishedHidden"="hidden", "publishedSortOrder"="sortOrder", "publishedAt"=now(), "updatedAt"=now()
WHERE "name"='Meeting → Diagram (Audio & Transcript)';
INSERT INTO "Feature" ("id","name","summary","details","hidden","sortOrder","publishedName","publishedSummary","publishedDetails","publishedHidden","publishedSortOrder","publishedAt","createdAt","updatedAt")
  SELECT gen_random_uuid()::text, 'Meeting → Diagram (Audio & Transcript)', 'Turn a recorded discussion into a diagram. Record or upload a conversation, or drop in a Microsoft Teams or Zoom transcript, and Diagramatix transcribes it, tidies it into an ordered process, and feeds it straight into AI Generate.', '- Three ways in — record a conversation live in the browser, upload an audio file (mp3, m4a, wav, webm…), or drop a Microsoft Teams or Zoom .vtt transcript
- High-accuracy, speaker-separated transcription via Deepgram — each voice is labelled, so distinct speakers can become distinct roles / lanes
- Meeting transcripts are read locally — a Teams or Zoom .vtt keeps everyone''s real names and costs nothing to process
- AI tidy pass — the raw, rambling transcript is cleaned into a clear, ordered process description (filler, repetition and small talk removed) before the diagram is built, so messy meetings still produce a sensible result
- Open questions surfaced — if the discussion left something ambiguous or unfinished, the AI flags it for you to resolve rather than guessing
- Flows into the same AI Generate pipeline for every notation — review and edit the plan (BPMN, Flowchart) or generate directly (Context, State Machine, Domain, Value Chain, ArchiMate)
- Nothing is sent until you choose: the transcript lands in the prompt box for you to read and refine first', false, 330, 'Meeting → Diagram (Audio & Transcript)', 'Turn a recorded discussion into a diagram. Record or upload a conversation, or drop in a Microsoft Teams or Zoom transcript, and Diagramatix transcribes it, tidies it into an ordered process, and feeds it straight into AI Generate.', '- Three ways in — record a conversation live in the browser, upload an audio file (mp3, m4a, wav, webm…), or drop a Microsoft Teams or Zoom .vtt transcript
- High-accuracy, speaker-separated transcription via Deepgram — each voice is labelled, so distinct speakers can become distinct roles / lanes
- Meeting transcripts are read locally — a Teams or Zoom .vtt keeps everyone''s real names and costs nothing to process
- AI tidy pass — the raw, rambling transcript is cleaned into a clear, ordered process description (filler, repetition and small talk removed) before the diagram is built, so messy meetings still produce a sensible result
- Open questions surfaced — if the discussion left something ambiguous or unfinished, the AI flags it for you to resolve rather than guessing
- Flows into the same AI Generate pipeline for every notation — review and edit the plan (BPMN, Flowchart) or generate directly (Context, State Machine, Domain, Value Chain, ArchiMate)
- Nothing is sent until you choose: the transcript lands in the prompt box for you to read and refine first', false, 330, now(), now(), now()
  WHERE NOT EXISTS (SELECT 1 FROM "Feature" WHERE "name"='Meeting → Diagram (Audio & Transcript)');
