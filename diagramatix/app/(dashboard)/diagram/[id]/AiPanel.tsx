...
export function AiPanel({
  ...
  async function handleCompare() {
    ...
    setError(null);
    setStatus("Comparing the available models (this takes a few minutes)…");
    try {
  ...
  return (
    <div className="w-80 border-l border-gray-200 bg-white flex flex-col shrink-0 overflow-hidden">
      ...
      <div className="flex-1 px-3 py-2 flex flex-col gap-2 overflow-y-auto">
        ...
        {/* The AI model in use is a SuperAdmin-only detail — regular users just
            get the default model, chosen server-side. */}
