...
**As at:** 2026-09-01  ·  **Document version:** 6.7  ·  **Suite:** 378 test files · 2,480 tests (all green)  ·  **Runner:** Vitest  ·  **CI:** enforced on every PR + push to `main`  ·  **Highest ref:** T3167  ·  **Plus:** a Playwright browser e2e suite — see [Layer 11](#layer-11--end-to-end-playwright-browser-tests)
