...
**As at:** 2026-08-29  ·  **Document version:** 6.7  ·  **Suite:** 358 test files · 2,301 tests (all green)  ·  **Runner:** Vitest  ·  **CI:** enforced on every PR + push to `main`  ·  **Highest ref:** T2989  ·  **Plus:** a Playwright browser e2e suite — see [Layer 11](#layer-11--end-to-end-playwright-browser-tests)
