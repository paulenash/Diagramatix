...
**As at:** 2026-08-26  ·  **Document version:** 6.5  ·  **Suite:** 338 test files · 2,159 tests (all green)  ·  **Runner:** Vitest  ·  **CI:** enforced on every PR + push to `main`  ·  **Highest ref:** T2890  ·  **Plus:** a Playwright browser e2e suite — see [Layer 11](#layer-11--end-to-end-playwright-browser-tests)
...
### What this is
Diagramatix has an automated **regression safety net** — a suite of **2,159 tests across 338 files** that runs the app's real code and fails loudly (“goes red”) the moment a change breaks documented behaviour. It is the early-warning system that lets the product change quickly without silently breaking sharing rules, data integrity, diagram layout, exports, the simulator, or AI generation.
