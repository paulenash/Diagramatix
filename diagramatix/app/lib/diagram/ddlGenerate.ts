...
const refs: RefTable[] = [
  ...
  { name: "ref_diagram_type", values: ["context","basic","process-context","state-machine","bpmn","domain","value-chain","archimate","flowchart"] },
  { name: "ref_symbol_type", values: ["task","gateway","start-event","intermediate-event","end-event","use-case","actor","team","state","initial-state","final-state","pool","lane","subprocess","subprocess-expanded","system-boundary","system-boundary-body","hourglass","composite-state","composite-state-body","system","data-object","data-store","group","text-annotation","external-entity","process-system","uml-class","uml-enumeration","uml-package","uml-note","uml-pain-point","uml-issue","sublane","fork-join","submachine","chevron","chevron-collapsed","process-group","archimate-shape","review-comment","flowchart-terminator","flowchart-process","flowchart-decision","flowchart-io","flowchart-document","flowchart-multidoc","flowchart-predefined","flowchart-preparation","flowchart-manual-input","flowchart-manual-op","flowchart-display","flowchart-delay","flowchart-database","flowchart-onpage","flowchart-offpage","flowchart-merge","flowchart-vswimlane"] },
  ...
  { name: "ref_connector_type", values: ["sequence","message","association","transition","associationBPMN","messageBPMN","flow","uml-association","uml-aggregation","uml-composition","uml-generalisation","uml-dependency","uml-realisation","uml-containment","uml-note-anchor","review-comment-link","flowline","archi-composition","archi-aggregation","archi-assignment","archi-realisation","archi-serving","archi-access","archi-influence","archi-association","archi-association-directed","archi-triggering","archi-flow","archi-specialisation"] },
