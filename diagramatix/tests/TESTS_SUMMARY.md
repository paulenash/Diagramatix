...
**As at:** 2026-09-03  ·  **Document version:** 6.8  ·  **Suite:** 380 test files · 2,500 tests (all green)  ·  **Runner:** Vitest  ·  **CI:** enforced on every PR + push to `main`  ·  **Highest ref:** T3187  ·  **Plus:** a Playwright browser e2e suite — see [Layer 11](#layer-11--end-to-end-playwright-browser-tests)
