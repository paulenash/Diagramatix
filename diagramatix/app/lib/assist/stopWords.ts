 ...
 */
const MIC = /^(?:stop|stop listening|stop it|that'?s enough|pause|abracadabra off|thank you gort)\b/i;
...
/** "stop" / "stop listening" / "that's enough" / "abracadabra off" — end the session. */
