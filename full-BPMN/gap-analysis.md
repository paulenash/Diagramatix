...
- **Next (optional):** BPMN 2.0 **exporter** (`.bpmn` round-trip); Tier 2 **Choreography** + **Conversation** diagram types; teach the AI generator + scan rules about the new complex-gateway / multiple-event / call-activity / compensation semantics.
