...
**As at:** 2026-09-16  ·  **Document version:** 7.0  ·  **Suite:** 507 test files · 3,745 tests (all green)  ·  **Runner:** Vitest  ·  **CI:** enforced on every PR + push to `main`  ·  **Highest ref:** T4885  ·  **Plus:** a Playwright browser e2e suite — see [Layer 11](#layer-11--end-to-end-playwright-browser-tests)
...
| T4613 | `tests/diagram/assist-block2-round2.test.ts` | "Undo" inside a numbered pick gets you out. It was answered "say the number of the item to rename" three times in a row in Paul's log — the feature arguing with someone trying to leave. It now drops the pick AND undoes, and the prompt names the way out ("cancel" to stop) rather than only the way to finish. |
