...
Composite: "location" — a place/site. Use "location" for any element whose name denotes a location, office, site, region or building (e.g. "Front Office", "Back Office", "Sydney HQ", "Melbourne Office", "Data Centre"), NOT "business-actor". A Location commonly CONTAINS other elements — nest them with "parent" as usual.
