...
const ADMIN_TILES: AdminTile[] = [
  ...
  { id: "compliance", title: "Compliance Monitoring", description: "Org-wide control operating-effectiveness over time — trends + alerts from Diagramatix Miner runs across every project.", href: "/dashboard/compliance?from=/dashboard/admin", feature: "riskControl" },
  ...
  { id: "abracadabra-commands", title: "Abracadabra Commands", description: "Every command the voice / typed editor accepts, by family, with example phrases — read from the code catalogue the tests hold to the grammar. Read-only: phrasings are code; the AI's aliases are editable in the Diagram Rules 'assist' category.", href: "/dashboard/admin/abracadabra-commands" },
  ...
  { id: "api-harness", title: "Process API — Test Harness", description: "Submit a process description and/or a document exactly as an external product would, over the real API, and see the pools, lanes, ordered activities and raw response that come back. Saved cases can be re-submitted to compare a prompt or model change against a fixed input.", href: "/dashboard/admin/api-harness", feature: "processApi" },
