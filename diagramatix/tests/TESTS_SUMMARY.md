...
**As at:** 2026-09-01  ·  **Document version:** 6.7  ·  **Suite:** 375 test files · 2,443 tests (all green)  ·  **Runner:** Vitest  ·  **CI:** enforced on every PR + push to `main`  ·  **Highest ref:** T3130  ·  **Plus:** a Playwright browser e2e suite — see [Layer 11](#layer-11--end-to-end-playwright-browser-tests)
...
| T3130 | `tests/valueChain/prompt-branches.test.ts` | A nested branch's End event does not vouch for its unterminated parent. |
