...
| **Progress log** | **2026-08-14** — first fix batch: **SEC-01**, **SEC-20**, **SIM-01** fixed (`<pending-sha>`). SIM-01 was re-scoped on implementation (see its row). |
...
- **Counts carried forward:** 12 Security · 12 Data-integrity · 15 Engine · 8 Canvas · 1 UI · 9 Import/Export · 10 Config + 2 new + 1 meta = **69 open items** at creation; **3 fixed 2026-08-14** (SEC-01, SEC-20, SIM-01) → **66 open.**
...
- **Wave A — Security you can fix in a day each:** ~~SEC-01~~, SEC-03, SEC-13, SEC-14, ~~SEC-20~~, SEC-21, ~~SIM-01~~. *(SEC-01, SEC-20, SIM-01 done 2026-08-14.)*
