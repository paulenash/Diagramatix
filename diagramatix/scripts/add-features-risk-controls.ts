...
const FEATURES: Array<{ name: string; summary: string; details: string; sortOrder: number }> = [
  {
    ...
    details: [
      ...
      "- Prove operating effectiveness from real data: tie a Control to the Diagramatix Miner conformance deviation a bypass would produce, and the matrix shows it was \"bypassed in N of M cases\" with an effectiveness % — evidence the control is actually operating, not just that it exists",
